...
|---|---|---|---|
| QA1 | Ingestão | Frequência do sync — diário basta, ou intradiário? | Agenda do T2 e expectativa de frescor (US2); com a pressão dos 49 dias, mais frequente = mais seguro |
