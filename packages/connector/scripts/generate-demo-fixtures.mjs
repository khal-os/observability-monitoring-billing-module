 ...
 *
 *   node packages/connector/scripts/generate-demo-fixtures.mjs                    # the 3 PoC profiles
 *   node packages/connector/scripts/generate-demo-fixtures.mjs --client tim        # generic profile for ANY client
 *
